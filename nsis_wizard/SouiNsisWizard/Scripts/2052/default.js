...
function AddConfig(proj, strProjectName) {
    try {
        ...
        if (WizardVersion >= 10.0) {
            ...
            config.OutputDirectory = '$(SolutionDir)nsis\\plugins\\';
        }
        else {
        ...
        if (config_x64 != null) {
            ...
            config_x64.ConfigurationType = typeDynamicLibrary;
            if (WizardVersion >= 10.0) {
                config_x64.IntermediateDirectory = '$(Configuration)64\\';
                config_x64.OutputDirectory = '$(SolutionDir)nsis\\plugins\\';
            }
            else {
            ...
            if (WizardVersion >= 10.0) {
                ...
                config_64.OutputDirectory = '$(SolutionDir)$nsis\\plugins\\';
            }
            else {
...
function GetSourceName(strName) {
    try {
        ...
        else if (strName.indexOf('[nsis]') == 0) {
            strName = "setupTemplate\\" + strName.substr(6);
        }
        return strName;
    }
    catch (e) {
...
function GetTargetName(strName, strProjectName) {
    try {
        ...
        if (strName == 'setupdll.cpp')
            strTarget = strProjectName + '.cpp';

        if (strName == 'setupdll.rc')
...
function AddFilesToCustomProj(proj, strProjectName, strProjectPath, InfFile) {
    try {
        ...
        var file2 = files.Item('pluginapi.c');
        var fileConfig2 = file2.FileConfigurations('Debug');
        fileConfig2.Tool.UsePrecompiledHeader = 0;
        fileConfig2 = file2.FileConfigurations('Release');
        fileConfig2.Tool.UsePrecompiledHeader = 0;
        ...
        if (fileConfig64 != null) {
            ...
            var fileConfig264 = file2.FileConfigurations('Debug|x64');
            fileConfig264.Tool.UsePrecompiledHeader = 0;
            fileConfig264 = file2.FileConfigurations('Release|x64');
            fileConfig264.Tool.UsePrecompiledHeader = 0;
        }
